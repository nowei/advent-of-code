...
class Pattern13:
    ...
    def __init__(self, pattern: List[str]):
        self.orig = pattern
        self.flipped = list(''.join(v) for v in zip(*[[c for c in row] for row in pattern]))
...
def solve_day13(input: Any, expected_pt1: Optional[int] = None, expected_pt2: Optional[int] = None):
